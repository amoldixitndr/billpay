...
module.exports.run = function(body, cb) {
	...
	flow()
		...
		.step('home', function(res, next) {
			var url = 'https://web.paymentvision.com/SuttellAndHammer/Login.aspx';
		...
		.step('wait_for_form', function(res, next) {
			return res.page.untilSelector('input#PageContent1_ctl00_CONTROL_LoginWidget_Txt_Password');
		})
		...
		.step('click_confirm_contact_info', function(res, next) {
