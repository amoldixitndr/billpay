...
module.exports.run = function(body, cb) {
	...
	flow()
		...
		.step('home', function(res, next) {
			var url = 'https://gulfsouthlegal.stratuspayments.net/';
		...
		.step('wait_for_form', function(res, next) {
			return res.page.untilSelector('input#check');
		})
		.step('delay', function(res, next) {
			_.delay(next, 500);
		})
		.step('click_check', function(res, next) {
			return res.page.click('input#check');
		})
