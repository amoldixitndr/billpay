...
module.exports.run = function(body, cb) {
	...
	flow()
		...
		.step('home', function(res, next) {
			var url = 'https://web.paymentvision.com/stengerlaw/login.aspx';
		...
		.step('click_confirm', function(res, next) {log.info('Clicking continue');
			return res.page.click('input#PageContent1_ctl00_CONTROL_CustomerProfile_Btn_Continue');
		})
		.step('wait_for_form', function(res, next) {log.info('waiting for tvtother');
